        ...
        <nav className="sticky top-0 z-1000">
            <div className="flex bg-black w-full ">
                ...
                <div className="flex justify-between items-center w-full">
                    ...
                    <div className="flex">
                        <a href="/">
                            <CiShoppingCart className="text-white cursor-pointer hover:text-[#4C9AFF] transition mr-5" size={24} />
                        </a>
                        <a href="/">
                            <CiUser className="text-white cursor-pointer hover:text-[#4C9AFF] transition mr-5" size={24} />
                        </a>
                        <a href="/">
                            <CiHeart className="text-white cursor-pointer hover:text-[#4C9AFF] transition mr-5" size={24} />
                        </a>

                        <a href="/Authentication/Login">
                            <CiLogin className="text-white cursor-pointer hover:text-[#4C9AFF] mx-5 transition mr-5" size={24} />
                        </a>
